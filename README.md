...
- **다음 판**은 보유 칩을 유지한 채 이어집니다. **처음부터**는 확인 후 현재 판과 칩을 초기화합니다.
- **게임 설정**에서 참가 인원과 상대 진행 속도를 바꿀 수 있습니다. 설정을 적용하면 새 게임을 시작합니다.
- **공용 카드 확인 후 진행**을 켜면 플랍·턴·리버 공개 때 멈춥니다. 카드를 보고 **계속**을 누르면 됩니다.
